...
public class LightningRod {
    ...
    public static Pokemon tryLightningRod (Pokemon originalSpawn, Map<Pokemon, Double> possibleSpawns) {
        ...
        for (Map.Entry<Pokemon, Double> entry : possibleSpawns.entrySet()) {
            ...
            if (entry.getKey().getForm().getTypes().contains(Element.ELECTRIC)) {
